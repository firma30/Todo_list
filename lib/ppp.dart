// ignore_for_file: avoid_print, duplicate_ignore, avoid_unnecessary_containers, use_build_context_synchronously, unrelated_type_equality_checks, unnecessary_null_comparison
                        ...
                        trailing: PopupMenuButton(
                          ...
                          onSelected: (value) async {
                            if (value == 1) {
                              ...
                              if (data != null) {
                                showform();
                                await dataToDo.doc(document.id).update(data);
                              }
                            }
                          },
                        )),
